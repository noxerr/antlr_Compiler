...
#endif
{
  ...
  if ( (LA(1)==STARTP) ) {
    ...
    if ( (LA(1)==CONN) ) {
      conexio(zzSTR); zzlink(_root, &_sibling, &_tail);
    }
    else {
      if ( (LA(1)==CRIT) ) {
        activitat(zzSTR); zzlink(_root, &_sibling, &_tail);
      }
...
#endif
{
  ...
  zzMake0;
  {
  zzmatch(CONN); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
  zzEXIT(zztasp1);
  return;
fail:
  zzEXIT(zztasp1);
...
#endif
{
  ...
  zzMake0;
  {
  zzmatch(CRIT); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
  zzEXIT(zztasp1);
  return;
fail:
  zzEXIT(zztasp1);
